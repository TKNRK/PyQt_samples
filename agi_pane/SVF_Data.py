...
def CMDS(G, profile, force=False):
    ...
    np.save(str(layout_dir.joinpath('layout_hd')), B.dot(L))  # なぜこの計算？
...
if __name__ == '__main__':
    dataset = '/Users/takano/Dropbox (smartnova)/work/data/svf-graph/polblogs.gml'
    dbpath = '/Users/takano/Dropbox (smartnova)/work/data/dataset'
    convert(
        PurePath(dbpath),
        dataset,
        force = True)
